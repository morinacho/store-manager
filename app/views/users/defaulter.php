<div class="grid">
	<?php foreach ($param['users'] as $user) : if ($user->buyer_defaulter){ ?>
		<!-- Vertical -->
		<div class="card ml-3 mb-3 border-warning grid-view" style="width: 10rem;">
		...
		<!-- Horizontal -->
		<div class="card mb-3 border-warning list-view" style="max-width: 480px;">
